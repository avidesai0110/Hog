...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls:
        ...
        if single_roll == 1:
            is_one = True
        dicescore = dicescore + single_roll
...
def boar_brawl(player_score, opponent_score):
    ...
    boar_score = (3 * abs((opponent_score // 10) - (player_score % 10)))
    if boar_score < 1:
        boar_score = 1
    return boar_score
    # END PROBLEM 2
...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    num_rolls:       The number of dice 4rolls that will be made.
    player_score:    The total score of the current player.
    opponent_score:  The total score of the other player.
    dice:            A function that simulates a single dice roll outcome.
    """
...
def sus_points(score):
    ...
    if num_factors(score) == 3 or num_factors(score) == 4:
        while is_prime(score) == False:
            print("DEBUG: " + str(score) )
            score+=1
        print("DEBUG: test" + str(score))
        return score
    return score
    # END PROBLEM 4
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    print("DEBUG: " + str(type(num_rolls)))
    score = player_score + take_turn(num_rolls, player_score, opponent_score, dice)
    #if num_factors(score) == 3 or num_factors(score) == 4:
    score = int(sus_points(score))
